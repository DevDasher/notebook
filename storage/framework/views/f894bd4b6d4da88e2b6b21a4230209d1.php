...
<body >
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('about')); ?>">درباره</a></li>
    ...
    <div class="d-flex bg-light flex-column min-vh-100">
        ...
        <footer class="py-5 bg-dark mt-auto">
            <div class="container px-5">
                <p class="m-0 text-center text-white">Copyright &copy; Notebook <?php echo e(date('Y')); ?></p>
            </div>
        </footer>
...
<?php /**PATH E:\code\notebook\resources\views/layouts/main.blade.php ENDPATH**/ ?>